Public Class register
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Dim scs As String = ""
        If TextBox_num.Text <> "" And TextBox_name.Text <> "" And ComboBox_sex.Text <> "" And TextBox_col.Text <> "" And TextBox_group.Text <> "" And TextBox_tel.Text <> "" Then
            scs = "update newmember set 性别='" & ComboBox_sex.Text & "',USERNAME='" & "',院系='" & TextBox_col.Text & "',座右铭='" & RichTextBox1.Text & "' where 学号='" & number_me & "'"
            sql(scs)
            sql_rele(conn, cmd)
            ...
            If myreader.Read() Then
                num_temp = myreader.Item(0)
                If num_temp = TextBox_num.Text Then
